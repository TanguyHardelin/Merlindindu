...
{
    public const string VillageNeedOpen = "VillageNeedOpen";
    public const string MillitaryNeedOpen = "MillitaryNeedOpen";
    public const string RessourcesNeedOpen = "RessourcesNeedOpen";
    public const string Evening = "Evening";
    public const string Night = "RessourcesNeedOpen";
